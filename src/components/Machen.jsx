                                ...
                                <Nav className="me-auto my-3 my-lg-5" style={{ maxHeight: '1000px' }} navbarScroll>
                                    ...
                                    <section className={a.menu_section}>
                                        ...
                                        <div className={a.menu_text}>
                                            <NavLink href="/menu"> <b className={a.b_menu}>Главная</b> </NavLink>
                                            <NavLink href="/consul"><b className={a.b_menu}>Консультация</b> </NavLink>
                                            <NavLink href="/Texnik"> <b className={a.b_menu}>Техника</b></NavLink>
